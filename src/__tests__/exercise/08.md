...
If you make it this far, I thought it'd be fun for you to try testing a more
real-world custom hook. We have a `use-undo.js` file with a `useUndo` hook.
You'll find an example component in `src/examples/undo.js`. You can either use
that or write your own and test `useUndo` with that custom component.
...
https://ws.kcd.im/?ws=Testing%20React%20Applications%20%F0%9F%A7%90&e=08%3A%20testing%20custom%20hooks&em=rita@vw-dilab.com
