...
We we think about how things are used, we need to consider who the users are:
...
component to that DOM node. You'll also need to clean up the DOM when you're
test is finished so the next test has a clean DOM to interact with.
...
https://ws.kcd.im/?ws=Testing%20React%20Applications%20%F0%9F%A7%90&e=01%3A%20simple%20test%20with%20ReactDOM&em=rita@vw-dilab.com
